...
Tile.read = function (pbf: any, end: any): any {
    return pbf.readFields(Tile._readField, {layers: []}, end);
};
Tile._readField = function (tag: any, obj: any, pbf: any): any {
    if (tag === 3) obj.layers.push(Tile.Layer.read(pbf, pbf.readVarint() + pbf.pos));
};
Tile.write = function (obj: any, pbf: any): any {
...
Tile.Value.read = function (pbf: any, end: any): any {
...
Tile.Value._readField = function (tag: any, obj: any, pbf: any): any {
...
Tile.Value.write = function (obj: any, pbf: any): any {
...
Tile.Feature.read = function (pbf: any, end: any): any {
    return pbf.readFields(Tile.Feature._readField, {id: 0, tags: [], type: 0, geometry: []}, end);
};
Tile.Feature._readField = function (tag: any, obj: any, pbf: any): any {
...
Tile.Feature.write = function (obj: any, pbf: any): any {
...
Tile.Layer.read = function (pbf: any, end: any): any {
    return pbf.readFields(Tile.Layer._readField, {version: 0, name: "", features: [], keys: [], values: [], extent: 0}, end);
};
Tile.Layer._readField = function (tag: any, obj: any, pbf: any): any {
...
Tile.Layer.write = function (obj: any, pbf: any): any {
